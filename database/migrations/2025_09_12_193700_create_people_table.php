...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('people', function (Blueprint $table) {
            ...
            $table->string('other_name', 120)->nullable()->comment('Si un concejal cambia de nombre, las transcripciones anteriores del consejo deben continuar con el nombre anterior');
            ...
            $table->string('summary')->nullable()->comment('Relato de una linea de la vida de una persona');
            $table->text('biography')->nullable()->comment('Relato extendido de la vida de una persona');
            $table->enum('status', StatusEnum::getValues())->comment('El estado actual de una persona');
            $table->timestamps(6);
